        ...
        >
          ...
          >
            <div className="items-centor flex w-fit flex-row justify-end gap-3">
              ...
              <JobSubmitButton
                isLoading={isPending}
                requestedResources={aggregateResourceLists([
                  {
                    resources: convertToResourceList(form.watch('ps.resource')),
                    replicas: form.watch('ps.replicas'),
                  },
                  {
                    resources: convertToResourceList(form.watch('worker.resource')),
                    replicas: form.watch('worker.replicas'),
                  },
                ])}
              />
            </div>
