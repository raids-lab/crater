...
const docTemplate = `{
        ...
        "/v1/jobtemplate": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort by createdAt or -createdAt",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Job template page",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-github_com_raids-lab_crater_internal_resputil_Page-internal_handler_JobTemplateresp"
                        }
                    },
                    "400": {
                        "description": "Request parameter error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-internal_handler_StorageCapabilitySummary"
                        }
                    }
                }
            }
        ...
        "/v1/storage/dirsize/{path}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Storage scope: user, account, or public",
                        "name": "path",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "github_com_raids-lab_crater_internal_resputil.Page-internal_handler_JobTemplateresp": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.JobTemplateresp"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-github_com_raids-lab_crater_internal_resputil_Page-internal_handler_JobTemplateresp": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-internal_handler_StorageCapabilitySummary": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
                ...
                "data": {
                    "$ref": "#/definitions/internal_handler.StorageCapabilitySummary"
                },
                "msg": {
                    "type": "string"
                }
        ...
        "internal_handler.JobTemplateresp": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "internal_handler.StorageCapabilitySummary": {
            "type": "object",
            "properties": {
                "quota_enabled": {
                    "type": "boolean"
