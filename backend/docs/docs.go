...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/admin/system-config/user-ban": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-internal_handler_UserBanPolicyReq"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.UserBanPolicyReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-internal_handler_UserBanPolicyReq": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
        ...
        "internal_handler.UserBanPolicyReq": {
            "type": "object",
            "properties": {
