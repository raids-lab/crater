...
U5. **能用表单就别来回追问** — 对 `create_jupyter_job`、`create_webide_job`、`create_training_job`、`create_custom_job`、`create_pytorch_job`、`create_tensorflow_job`、`create_image_build`、`resubmit_job`，若还有少量可编辑字段缺失，可以先调用写工具让系统渲染确认表单，不要为这些字段在聊天里绕圈
