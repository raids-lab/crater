...
from agent.state import CraterAgentState
from config import settings
from llm.client import ModelClientFactory
from skills.loader import load_relevant_skills
from tools.definitions import ALL_TOOLS
from tools.executor import GoBackendToolExecutor, ToolExecutorProtocol
...
async def _proactive_compact(
    ...
    if llm is not None:
        from agent.compaction import compact_messages_with_llm
