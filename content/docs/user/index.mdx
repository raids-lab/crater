...
<Cards>
  <Card href="/cn/docs/user/quick-start/login" title="平台访问">
    了解如何在实验室内部访问 Crater 平台
  </Card>
  <Card href="/cn/docs/user/quick-start/interactive" title="交互式作业">
    了解如何使用交互式作业
  </Card>
  <Card href="/cn/docs/user/quick-start/batchprocess" title="自定义作业">
    了解如何使用自定义作业
  </Card>
  <Card href="/cn/docs/user/file/file" title="文件系统">
    了解如何使用文件系统
  </Card>
  <Card href="/cn/docs/user/file/dataset" title="数据集">
    了解如何使用数据集
  </Card>
  <Card href="/cn/docs/user/image/imagebuild" title="镜像制作">
    了解如何制作镜像
  </Card>
</Cards>
