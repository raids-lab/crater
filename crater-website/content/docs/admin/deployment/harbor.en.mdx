---
title: Harbor Deployment Guide
description: Crater relies on an internal Harbor registry to support image building, storage, and secure distribution within the cluster. 
