...
| backendConfig.modelMetadata.logoAllowedHosts | list | `["huggingface.co", "cdn-avatars.huggingface.co"]` | Exact HTTPS host allowlist for fetching and caching logos; every redirect hop is checked |
