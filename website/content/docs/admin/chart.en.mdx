...
| backendConfig.registry.buildTools.proxyConfig.httpProxy | string | `null` | HTTP egress proxy used by image builds and Hugging Face download Jobs |
| backendConfig.registry.buildTools.proxyConfig.httpsProxy | string | `null` | HTTPS egress proxy used by image builds and Hugging Face download Jobs |
| backendConfig.registry.buildTools.proxyConfig.noProxy | string | `null` | Comma-separated addresses bypassed by image builds and Hugging Face download Jobs |
