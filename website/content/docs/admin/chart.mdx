...
| backendConfig.registry.buildTools.proxyConfig.httpProxy | string | `null` | 镜像构建和 Hugging Face 下载 Job 使用的 HTTP 出站代理 |
| backendConfig.registry.buildTools.proxyConfig.httpsProxy | string | `null` | 镜像构建和 Hugging Face 下载 Job 使用的 HTTPS 出站代理 |
| backendConfig.registry.buildTools.proxyConfig.noProxy | string | `null` | 镜像构建和 Hugging Face 下载 Job 不走代理的地址列表（逗号分隔） |
