...
| backendConfig.modelDownload | object | `{"huggingFaceEndpoint":"https://huggingface.co","image":"crater-harbor.act.buaa.edu.cn/docker.io/library/python:3.11-slim","modelScopeEndpoint":"https://modelscope.cn"}` | Model download functionality configurations |
...
| backendConfig.modelMetadata | object | `{"huggingFaceEndpoints":["https://huggingface.co"],"logicalPublicPrefix":"public","maxLogoBytes":524288,"modelScopeEndpoints":["https://modelscope.cn"],"timeoutSeconds":20}` | Model and dataset source metadata refresh configuration |
...
| modelMetadataRefresh | object | `{"batchSize":100,"delay":"100ms","enabled":true,"extraEnv":[],"resources":{"limits":{"cpu":"500m","memory":"512Mi"},"requests":{"cpu":"50m","memory":"64Mi"}},"schedule":"15 */6 * * *","staleAfter":"168h"}` | Periodically refresh public model and dataset metadata from configured source endpoints |
...
| modelMetadataRefresh.enabled | bool | `true` | Enable the metadata refresh CronJob |
