...
| backendConfig.modelMetadata | object | `{"huggingFaceEndpoints":["https://huggingface.co"],"logoAllowedHosts":["huggingface.co","cdn-avatars.huggingface.co"],"logicalPublicPrefix":"public","maxLogoBytes":524288,"modelScopeEndpoints":["https://modelscope.cn"],"timeoutSeconds":20}` | Model and dataset source metadata refresh configuration |
...
| backendConfig.modelMetadata.logoAllowedHosts | list | `["huggingface.co","cdn-avatars.huggingface.co"]` | Exact HTTPS hosts allowed when caching source logos; add trusted mirror/CDN hosts as needed |
